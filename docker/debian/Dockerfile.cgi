...
LABEL org.opencontainers.image.authors="Snowdream Tech" \
    ...
    org.opencontainers.image.description="Docker Images for PHP on Debian. (amd64, arm32v7, arm64, ppc64le, riscv64, s390x)" \
